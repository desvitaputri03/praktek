 ...
 */
package Vita_Controller;


import Vita_Dao.MahasiswaDb;
import Vita_Model.Mahasiswa;
import Vita_View.FormMahasiswa;
...
public class MahasiswaControllerDb {
    ...
    public void viewData(){
        try {
            ...
            model.setNumRows(0);
            List<Object> list = mahasiswaDb.getAllMahasiswa();
            for (Iterator<Object> it = list.iterator(); it.hasNext();) {
                Mahasiswa mahasiswa = (Mahasiswa) it.next();
                Object[] data = {
                    mahasiswa.getNobp(),
                    mahasiswa.getNama(),
                    mahasiswa.getAlamat(),
    ...
    public  void actionClickTabel(){
        try {
            ...
            mahasiswa = (Mahasiswa) mahasiswaDb.getMahasiswa(nobp);
